      ...
      <div className="main">
        ...
        <div className="about-box" id="aboutbox">
          ...
          <p>
            ...
            <a href="#conditions" id="conditions">Terms and Conditionss</a>
          </p>
        </div>
      </div>

          <div className="condition-container" id="condition">
            <div className="conditions-box">
              <div className="conditions-box-headers">
                <h3 className="conditions-header">Terms and Conditions</h3>
                <span id="closeicon" role="button" aria-label="Close">&times;</span>
              </div>
              <ol>
